...
class PostList extends Component {
    ...
    componentDidMount() {
        ...
        axios.get('https://jsonplaceholder.typicode.com/ggposts')//this methods accepts the API endpoint as its arguments(now we are making a get request), but how do we access tje data that is returned, well axios is promised based library 
            .then(response => {
